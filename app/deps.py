...
from app.utils import (
    get_admin_from_cookie, find_share_by_vpath,
    check_access, get_absolute_path, write_log, mask_key, ShareConfig,
)
...
async def verify_access(
    ...
    if err_msg:
        ...
        write_log({"action": "access_denied", "path": path,
                    "ip": request.client.host, "key": mask_key(key), "reason": err_msg})
